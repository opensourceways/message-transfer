...
RUN mkdir -p /go/src/github.com/opensourceways/messgae-transfer
COPY . /go/src/github.com/opensourceways/messgae-transfer
RUN cd /go/src/github.com/opensourceways/messgae-transfer && CGO_ENABLED=1 go build -v -o ./messgae-transfer main.go
